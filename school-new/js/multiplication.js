...
`<div class="row ps-3 pe-3 mb-3">
	<button id="btn-check" type="button" class="btn btn-primary fs-5 w-75 m-auto">Перевірити</button>
</div>`
}
createBtnCheck()
...
`<div class="row ps-3 pe-3 mb-3">
	<button id="btn-new" type="button" class="btn btn-success fs-5 w-75 m-auto">Новий приклад</button>
</div>`
}
createBtnNew()
